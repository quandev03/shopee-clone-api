...
public class CommentService {
    ...
    public ResponseEntity<?> addComment(RequestAddComment comment, Long idProduct) {
        try {
    ...
    public ResponseEntity<?> editComment(RequestAddComment contentEdit, Long idComment) {
        try {
    ...
    @Transactional
    public ResponseEntity<?> deleteAComment(Long idComment) {
        try {
            Comment comment = commentRepository.findById(idComment).orElseThrow(() -> new RuntimeException("Comment not found"));
